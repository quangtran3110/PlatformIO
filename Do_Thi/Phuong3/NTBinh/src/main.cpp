...
WiFiClient client;
HTTPClient http;
#define URL_fw_Bin "https://raw.githubusercontent.com/quangtran3110/PlatformIO/main/Do_Thi/Phuong3/NTBinh/.pio/build/nodemcuv2/firmware.bin"
String server_name = "http://sgp1.blynk.cloud/external/api/";
//-----------------------------
#define pin_terminal "&V23="
#define pin_G "&V24="
#define pin_mode "&V25="
String location = urlEncode("Phường 3 - Trường N.T.Bình\n");
//-----------------------------
...
void temperature() { // Nhiệt độ
  ...
  for (byte i = 0; i < sensors.getDeviceCount(); i++) {
    ...
    if (temp[i] > 37 && sta_rl3 == LOW)
      on_fan();
    else if (temp[i] < 34 && sta_rl3 == HIGH)
      off_fan();
  }
