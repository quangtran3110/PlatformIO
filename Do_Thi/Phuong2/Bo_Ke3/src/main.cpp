...
WiFiClient client;
HTTPClient http;
#define URL_fw_Bin "https://raw.githubusercontent.com/quangtran3110/PlatformIO/main/Do_Thi/Phuong2/Bo_Ke3/.pio/build/nodemcuv2/firmware.bin"
...
#define pin_mode "&V51="
#define pin_Irms "&V53="
String location = urlEncode(" P2 - Bờ kè 3\n");
//-----------------------------
struct Data {
  byte mode;
  byte reboot_num;
