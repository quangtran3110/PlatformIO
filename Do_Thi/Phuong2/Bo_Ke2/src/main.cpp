...
#define BLYNK_AUTH_TOKEN "T86HBKpJBPvMbJeGRF8mKPEUf83Oik9A"
...
bool trip0 = false;
int xSetAmpe = 0;
float Irms0, prev_Irms0 = 0, SetAmpemax = 7, SetAmpemin = 2;
...
WiFiClient client;
HTTPClient http;
#define URL_fw_Bin "https://raw.githubusercontent.com/quangtran3110/PlatformIO/main/Do_Thi/Phuong2/Bo_Ke2/.pio/build/nodemcuv2/firmware.bin"
String server_name = "http://sgp1.blynk.cloud/external/api/";
//-----------------------------
#define pin_terminal "&V44="
#define pin_G "&V45="
#define pin_mode "&V46="
#define pin_Irms "&V48="
String location = urlEncode("Phường 2 - Bờ kè 2\n");
//-----------------------------
struct Data {
  byte mode;
  byte reboot_num;
  ...
  if (rms0 < 2) {
    ...
    if ((yIrms0 > 3) && ((Irms0 >= SetAmpemax) || (Irms0 <= SetAmpemin))) {
      ...
      if (xSetAmpe >= 4) {
        ...
        xSetAmpe = 0;
        trip0 = true;
        String dataS = "Bơm bờ kè 2 lỗi! " + String(Irms0) + "A";
