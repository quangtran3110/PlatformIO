...
#define BLYNK_TEMPLATE_NAME "CAY XANH"
#define BLYNK_AUTH_TOKEN "t9ZvFY3Syiz5C_efTM-PAS5mg0PGJgxv"
...
#define pin_G "&V9="
String location = urlEncode(" P2 - C.C.Đông\n");
//-----------------------------
struct Data {
  byte mode;
  byte reboot_num;
...
bool sta_rl1 = LOW, prev_sta_rl1 = LOW;
String num_van;
char s_day[50] = "";
char B[50] = "";
